"""
OpenSearch mock backend adapter for benchmarking.

This is a mock implementation that simulates OpenSearch's lexical search
behavior for benchmarking purposes. It uses simple in-memory search
with basic BM25-like scoring.

For production, this would be replaced with actual opensearch-py client.
"""
...
class OpenSearchBackend(LexicalBackend):
    """
    Mock OpenSearch backend for lexical search benchmarking.
    ...
    For actual OpenSearch integration, use opensearch-py client.
    """

    def __init__(self):
        """Initialize the mock OpenSearch backend."""
    ...
    def get_stats(self) -> BackendStats:
        ...
        # Add overhead for inverted index (OpenSearch has more overhead)
        index_overhead = len(self._inverted_index) * 150
        ...
        return BackendStats(
            ...
            additional_info={
                ...
                "implementation": "mock",
                "version": "2.x"  # OpenSearch version
            }
        )
    ...
    def _tokenize(self, text: str) -> List[str]:
        ...
        OpenSearch uses the standard analyzer by default which
        performs similar tokenization.
    ...
    def _compute_bm25_score(
        ...
        OpenSearch uses BM25 as its default similarity algorithm.
